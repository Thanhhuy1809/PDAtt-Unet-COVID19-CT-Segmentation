...
database_path = r'C:\Users\LUU VAN THANH HUY\PycharmProjects\PythonProject\PBL4\PDAtt-Unet-main2\PDAtt-Unet-main2\data\9CTscans\Dataset1\rp_im'
...
training = (X, y, y2)
torch.save(training, 'Training_data1.pt')
...
training = (X, y, y2)
torch.save(training, 'Validation_data1.pt')