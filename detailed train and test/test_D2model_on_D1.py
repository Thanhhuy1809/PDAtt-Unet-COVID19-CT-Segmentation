...
# FULL Dataset_1 từ prepare_dataset1_full.py
...
# Results output
result_dir = os.path.join(base_dir, 'Model_D2_test_D1', 'PYAttUNet', 'Results')
...
for itr in range(runs):
    ...
    with open(result_path, "w") as f:
        print(f'Run {itr} | D2 -> D1 (full)', file=f)
        print('-' * 10, file=f)
...
print('\n========== FINAL RESULTS (Table 9 - D2 model on full D1) ==========')
